      ...
      <section class="content">
          ...
          <div class="card">
              <div class="card-header">
                  <h3 class="card-title">Tambah Data Jenis Fasilitas</h3>
              </div>
              <div class="card-body col-md-6">
                  <form id="formTambah" action="" method="post">
                      <div class="modal-body">
                          <?php
                            $cekurutan = $this->db->query('SELECT * FROM jenisfasilitas ORDER BY urutan DESC');
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" name="nama_jenisfasilitas" class="form-control" id="nama_jenisfasilitas" value="<?= set_value('nama_jenisfasilitas'); ?>" placeholder="Isi Nama Jenis Fasilitas">
