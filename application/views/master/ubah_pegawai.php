                  ...
                  <form id="formTambah" action="" method="post">
                      ...
                      <div class="modal-body">
                          <div class="form-group">
                              ...
                              <input type="text" name="nip" class="form-control" id="nip" value="<?= $masterpegawai['nip']; ?>" placeholder="Isi NIP">
                              <small class="text-danger"><?= form_error('nip'); ?></small>
                          </div>
                          <div class="form-group">
                              <label for="nama_pegawai">Nama Pegawai</label>
                              <input type="text" name="nama_pegawai" class="form-control" id="nama_pegawai" value="<?= $masterpegawai['nama_pegawai']; ?>" placeholder="Isi Nama Pegawai">
                          ...
                          <div class="form-group">
                              ...
                              <select class="form-control select2 select2-hidden-accessible" name="id_golpangkat" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                  <?php foreach ($mastergolpangkat as $golp) :; ?>
                                      <?php
                                        if ($golp['id_golpangkat'] == $masterpegawai['id_golpangkat']) {

                                        ?>
                                          <option value="<?= $golp['id_golpangkat']; ?>" selected="selected"><?= $golp['nama_pangkat'] . '/' . $golp['nama_gol']; ?></option>
                                      <?php
                                        } else {
                                        ?>
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" name="tempat_lahir" class="form-control" id="tempat_lahir" value="<?= $masterpegawai['tempat_lahir']; ?>" placeholder="Isi Tempat Lahir">
                              <small class="text-danger"><?= form_error('tempat_lahir'); ?></small>
                          </div>
                          <div class="form-group">
                              <label>Tanggal Lahir</label>
                              <div class="input-group date" id="reservationdate1" data-target-input="nearest">
                                  <input type="text" class="form-control datetimepicker-input" name="tanggal_lahir" data-target="#reservationdate1" data-toggle="datetimepicker" value="<?= date('d-m-Y', strtotime($masterpegawai['tanggal_lahir'])); ?>">
