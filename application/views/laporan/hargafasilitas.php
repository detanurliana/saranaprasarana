        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label>Filter Jenis hargafasilitas :</label>
                                            <select class="form-control select2 select2-hidden-accessible" name="id_fasilitas" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                                ...
                                                <?php foreach ($fasilitas as $jb) :; ?>
                                                    <option value="<?= $jb['id_fasilitas']; ?>"><?= $jb['nama_fasilitas']; ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                ...
                <?php if (($this->session->flashdata()) and (isset($input_fasilitas))) : ?>
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="invoice p-3 mb-3">
                                ...
                                <div class="row no-print">
                                    <div class="col-12">
                                        <form id="formTambah" action="<?= base_url('laporan/cetakhargafasilitas'); ?>" method="post" target="_blank">
                                            <input type="hidden" name="id_fasilitas" value=<?= $input_fasilitas; ?>>
