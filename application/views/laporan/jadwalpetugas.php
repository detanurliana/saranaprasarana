                        ...
                        <div class="col-12">
                            ...
                            <div class="invoice p-3 mb-3">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($filter as $ft) :
                                                    ...
                                                    $dari_jam = $ft['dari_jam'];
                                                    $sampai_jam = $ft['sampai_jam'];
                                                ?>
                                                    <tr>
                                                        <td><?= $no; ?></td>
                                                        ...
                                                        <td><?= $nama_kegiatan; ?></td>
                                                        <td><?= $nama_petugas; ?></td>
                                                        <td><?= tanggal_indo($ft['tanggal_jadwal']); ?></td>
                                                        <td><?= $dari_jam . ' | ' . $sampai_jam; ?></td>
                                                    </tr>
                                                <?php $no++;
                                                endforeach; ?>
                                            </tbody>
                                ...
                                <div class="row no-print">
                                    <div class="col-12">
                                        <form id="formTambah" action="<?= base_url('laporan/cetakjadwalpetugas'); ?>" method="post" target="_blank">
