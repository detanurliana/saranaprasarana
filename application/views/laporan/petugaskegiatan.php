                        ...
                        <div class="col-12">
                            ...
                            <div class="invoice p-3 mb-3">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $nama_pemesan; ?></td>
                                                        <td><?= $nama_kegiatan; ?></td>
                                                        <td><?= tanggal_indo($kegiatan['dari_tanggal']) . ' s.d ' . tanggal_indo($kegiatan['sampai_tanggal']); ?></td>
                                                        <td><?= $selisih; ?></td>
                                                        <td><?= $nama_petugas; ?></td>
                                                        <td><?= $tupoksi; ?></td>
                                                    </tr>
                                ...
                                <div class="row no-print">
                                    <div class="col-12">
                                        <form id="formTambah" action="<?= base_url('laporan/cetakpetugaskegiatan'); ?>" method="post" target="_blank">
