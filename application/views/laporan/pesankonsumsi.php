                        ...
                        <div class="col-12">
                            ...
                            <div class="invoice p-3 mb-3">
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($filter as $ft) :
                                                    ...
                                                    $id_konsumsi = $ft['id_konsumsi'];
                                                    $konsumsi = $this->db->get_where('konsumsi', ['id_konsumsi' => $id_konsumsi])->row_array();
                                                    $nama_konsumsi = $konsumsi['nama_konsumsi'];
                                                    $harga = $konsumsi['harga'];
                                ...
                                <div class="row no-print">
                                    <div class="col-12">
                                        <form id="formTambah" action="<?= base_url('laporan/cetakpesankonsumsi'); ?>" method="post" target="_blank">
